        ...
        <div class="catbox">
            ...
            <div class="bspace" id="subcatrows">
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    if ($row['status'] == 1) {
                        $st = "Active";
                        $cb = "<button class='deactive' style='background-color:green' onclick='subcat_acdc($idd, 0)'>
                  <i class='fa fa-eye-slash' aria-hidden='true'></i>Deactive
                </button>";
                    } else {
                        $st = "Deactive";
                        $cb = "
                <button class='active' style='background-color:green' onclick='subcat_acdc($idd, 1)'>
...
<div class='action'>
  <button class='edit' style='background-color:maroon' onclick='editsubcat($id)'>
    <i class='fa fa-pen' aria-hidden='true'></i>Edit
  </button>
  $cb
  <button class='delete' style='background-color:maroon' onclick='subcatdelete($id)'>
