    ...
    <header class="header">
        <div class="top-header">
            <div class="th">
                ...
                <div class="name" style="color:maroon">
                    FARMGO LTD <br />
                    <span style="color:maroon">Market</span>
                </div>
                <div class="selecloc">
                    <div class="dropdown" tabindex="0">
                        <div class="text">
                            <i class="uil uil-location-point" style="color:maroon"></i>
                            <?php
                    ...
                    <ul>
                        <li>
                           ...
                           <?php
                                    ...
                                    ?>
                        <li>
                            <a href="http://keerthiefarmer.xyz/seller/index.php" class="rightlink">
                                <i class="uil uil-user-circle bg"></i>
                                Seller Login
                            </a>
                        </li>
                        <li>
                            <a href="http://keerthiefarmer.xyz/Admin/index.php" class="rightlink">
                                <i class="uil uil-user-circle bg"></i>
                                Admin Login
                            </a>
                        </li>
                        ...
                        <li class="user">
                            <a href="javascript:void(0)" class="rightlink">Client Login
