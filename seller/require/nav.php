<div class="left-part" id="lft" style="background-color:maroon; color:white;">
    <div class="logo">
    ...
    <div class="list-nav" style="background-color:maroon">
        <ul class="nav-list">
            <?php 
    ...
    <div class="copyright" >
        <p>Developed by FARMGO LTD ICT Team</p>
    </div>
</div>